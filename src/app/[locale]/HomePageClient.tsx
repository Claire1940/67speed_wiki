...
export default function HomePageClient({
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {t.modules.lucidBlocksSteamDeckAndController.items.map((item: any, index: number) => (
              <div key={index} className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                <span className="inline-flex items-center px-3 py-1 mb-3 rounded-full text-xs font-semibold bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)]">
                  {item.label}
                </span>
                <h3 className="text-xl font-bold mb-2 text-[hsl(var(--nav-theme-light))]">
      ...
      <section id="67-speed-viral-trend" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal relative">
            <div className="hidden xl:block absolute top-9 left-0 right-0 h-px bg-[hsl(var(--nav-theme)/0.25)]" />
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 relative">
              {t.modules.lucidBlocksSettingsAndAccessibility.settings.map((event: any, index: number) => (
                <div key={index} className="p-5 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition-colors">
                  <div className="mb-3">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)]">
                      {event.date}
                    </span>
                  </div>
      ...
      {/* Module 16: Device Compatibility */}
      <section id="67-speed-device-compatibility" className="scroll-mt-24 px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="scroll-reveal hidden md:block overflow-x-auto border border-border rounded-xl mb-6 bg-white/5">
            <table className="w-full min-w-[860px]">
              <thead className="bg-[hsl(var(--nav-theme)/0.08)] border-b border-border">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-bold">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.platform}</th>
                  <th className="px-4 py-3 text-left text-sm font-bold">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.availability}</th>
                  <th className="px-4 py-3 text-left text-sm font-bold">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.access}</th>
                  <th className="px-4 py-3 text-left text-sm font-bold">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.notes}</th>
                </tr>
              </thead>
              <tbody>
                {t.modules.lucidBlocksCrashFixAndTroubleshooting.items.map((item: any, index: number) => (
                  <tr key={index} className="border-b border-border/50 hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-4 py-4 text-sm text-muted-foreground">{item.access}</td>
                    <td className="px-4 py-4 text-sm text-muted-foreground">{item.notes}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <div className="scroll-reveal md:hidden space-y-4 mb-6">
            {t.modules.lucidBlocksCrashFixAndTroubleshooting.items.map((item: any, index: number) => (
              <div key={index} className="p-5 bg-white/5 border border-border rounded-xl">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <p className="font-semibold mb-1">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.access}</p>
                    <p className="text-muted-foreground">{item.access}</p>
                  </div>
                  <div>
                    <p className="font-semibold mb-1">{t.modules.lucidBlocksCrashFixAndTroubleshooting.tableHeaders.notes}</p>
          ...
          <div className="scroll-reveal p-6 bg-[hsl(var(--nav-theme)/0.08)] border border-[hsl(var(--nav-theme)/0.3)] rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-[hsl(var(--nav-theme-light))] mb-2">Need a 67 Speed setup check?</h3>
                <p className="text-sm text-muted-foreground mb-3">Use the official channels for compatibility and account support:</p>
